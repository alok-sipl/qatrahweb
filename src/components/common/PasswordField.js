            ...
            return(
                <View style={{flex:1}}>
                    <Item  rounded  style={{elevation: 2,marginBottom:3,shadowOpacity: 0,backgroundColor:'#fff'}}  error={(isSubmitted == true && !(validatePassword(value)) && (oldPassword != value))}
                      ...
                      <InputText   placeholderTextColor="#949dac"  disabled={isDisabled} placeholder={label} secureTextEntry={secureTextEntry}  autoCorrect={false}  value={value} onChangeText={onChangeText} maxLength={30}  />
