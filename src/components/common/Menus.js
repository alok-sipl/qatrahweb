const Menues =
    {
        menu:
            [
                ...
                {name: 'Remainder Settings', link: 'NotificationSetting',icon:"md-settings",key:4,submenu:[{name:'Notification Settings', link: 'NotificationSetting',icon:"ios-notifications",key:1}]},
