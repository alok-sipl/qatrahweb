...
class NotificationSetting extends Component {
    state = {menuActive: false, isSubmitted: false,isLoading:true};
                            ...
                            <div className="card-panel">
                                <div className="repeat"><span className="txt">Send Notification</span>
                                    <label className="switch notifi">
                                        <input type="checkbox" defaultChecked={this.props.is_user_notification}
                                               onChange={(event) => {
                                                   this.OnSendNotificationChanged(event.target.checked)
                                               }} checked={this.props.is_user_notification}
                                               value={this.props.is_user_notification}/>
...
export default connect(mapStateToProps, {
    ...
    getUserDetailsForNotificationSettings,
