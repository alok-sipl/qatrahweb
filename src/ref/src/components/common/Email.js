    ...
    return(
           <View style={{flex:1}}>
            <Item  style={{elevation: 2,marginBottom:3,shadowOpacity: 0.3,backgroundColor:'#fff'}} rounded  error={(isSubmitted == true && !(validateEmail(value)))}
                ...
                <InputText  onFocus={onFocus} onBlur={onBlur} disabled={isDisabled} secureTextEntry={secureTextEntry}  autoCorrect={false}   value={value} onChangeText={onChangeText} maxLength={45} keyboardType="email-address" placeholderTextColor="#949dac" style={{color:"#949dac"}} />
            </Item>
